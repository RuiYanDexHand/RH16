...
//*     *pusId        - [o] 消息对应的节点ID
//* 返回值 - 参考枚举类型 enret_t 及对应解释
Exportmode u8_t AsynParse_RyFunc_SetSNCode(CanMsg_t stuRxmsg, u8_t ucCmd, u16_t *pusId);
...
//* 返回值 - 参考枚举类型 enret_t 及对应解释
//*********************************************************************************************************************************
Exportmode u8_t AsynParse_RyParam_SetTime(CanMsg_t stuRxmsg, u8_t ucCmd, u16_t *pusId);
...
//* 返回值 - 参考枚举类型 enret_t 及对应解释
//*********************************************************************************************************************************
Exportmode u8_t AsynParse_RyParam_SetRigidity(CanMsg_t stuRxmsg, u8_t ucCmd, u16_t *pusId);
